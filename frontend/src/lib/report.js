...
import { accountStatusLabel, cpaLabel as cpaClass, cpaMedian, computeSaldo, PERIOD_LABELS } from "./saldo";
import brandcastLogoUrl from "../assets/brandcastlogo.png";

// Helpers locais que eram exportados em format.js no legacy.
